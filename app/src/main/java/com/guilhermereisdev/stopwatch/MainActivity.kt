package com.guilhermereisdev.stopwatch
...
import com.guilhermereisdev.stopwatch.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun startOrStop() = if (isStarted) stop() else start()
